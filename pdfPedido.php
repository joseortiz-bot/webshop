...
class MYPDF extends TCPDF
{
    ...
    {
        $image_file = dirname(__FILE__) . '/assets/images/buho.png';
...
$pdf->SetXY(145, 35); // Ajusta la posición vertical según tus necesidades
$pdf->Write(0, 'Nombre: José Ortiz');

$pdf->SetXY(10, 45); // Ajusta la posición vertical según tus necesidades
$pdf->Write(0, 'Despacho: No se despacha a domicilio, el cliente viene a buscar sus productos.');
...
$pdf->Ln(20);
$html = '
<h1 align="center">BOLETA DE VENTA WEB SHOP<hr class="hr-1"></h1>
<style>
hr {
...
$pdf->writeHTML('
<br><br>
<p align="center"><strong>Datos de cuenta web shop para Transferencia bancaria:</strong></p>
<p align="center"><strong>NOMBRE:</strong> WEB SHOP</p>
<p align="center"><strong>RUT:</strong> 77.789.222-5</p>
<p align="center"><strong>BANCO:</strong> BCI</p>
<p align="center"><strong>TIPO DE CUENTA:</strong> CUENTA CORRIENTE</p>
<p align="center"><strong>NUMERO DE CUENTA:</strong> 4555255</p>
<p align="center"><strong>EMAIL:</strong> WEBSHOP@GMAIL.CL</p>
');
